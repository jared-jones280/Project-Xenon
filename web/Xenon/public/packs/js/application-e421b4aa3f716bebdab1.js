/******/ (function (modules) {
  ...
  /******/ return __webpack_require__(
    (__webpack_require__.s = "./app/javascript/packs/application.js")
  );
  /******/
})(
  /************************************************************************/
  ...
  \******************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var channels = __webpack_require__(
          "./app/javascript/channels sync recursive _channel\\.js$"
        );
  ...
  \*********************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _rails_ujs__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! @rails/ujs */ "./node_modules/@rails/ujs/lib/assets/compiled/rails-ujs.js"
          );
        /* harmony import */ var _rails_ujs__WEBPACK_IMPORTED_MODULE_0___default =
          /*#__PURE__*/ __webpack_require__.n(
            _rails_ujs__WEBPACK_IMPORTED_MODULE_0__
          );
        /* harmony import */ var turbolinks__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! turbolinks */ "./node_modules/turbolinks/dist/turbolinks.js"
          );
        /* harmony import */ var turbolinks__WEBPACK_IMPORTED_MODULE_1___default =
          /*#__PURE__*/ __webpack_require__.n(
            turbolinks__WEBPACK_IMPORTED_MODULE_1__
          );
        /* harmony import */ var _rails_activestorage__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! @rails/activestorage */ "./node_modules/@rails/activestorage/app/assets/javascripts/activestorage.js"
          );
        /* harmony import */ var _rails_activestorage__WEBPACK_IMPORTED_MODULE_2___default =
          /*#__PURE__*/ __webpack_require__.n(
            _rails_activestorage__WEBPACK_IMPORTED_MODULE_2__
          );
        /* harmony import */ var channels__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! channels */ "./app/javascript/channels/index.js"
          );
        /* harmony import */ var channels__WEBPACK_IMPORTED_MODULE_3___default =
          /*#__PURE__*/ __webpack_require__.n(
            channels__WEBPACK_IMPORTED_MODULE_3__
          );
        ...
        (function (global, factory) {
            ...
            if (object && typeof object[methodName] == "function") {
              for (
                var _len = arguments.length,
                  messages = Array(_len > 2 ? _len - 2 : 0),
                  _key = 2;
                _key < _len;
                _key++
              ) {
          ...
          var DirectUploadsController = (function () {
            function DirectUploadsController(form) {
              ...
              this.form = form;
              this.inputs = findElements(form, inputSelector).filter(function (
                input
              ) {
          ...
          function submitForm(form) {
            var button =
              submitButtonsByForm.get(form) ||
              findElement(form, "input[type=submit], button[type=submit]");
            ...
            (function () {
              (function () {
                ...
                Rails.loadCSPNonce = function () {
                  var ref;
                  return (nonce =
                    (ref = document.querySelector("meta[name=csp-nonce]")) !=
                    null
                      ? ref.content
                      : void 0);
                };
              ...
              (function () {
                ...
                Rails.refreshCSRFTokens = function () {
                  ...
                  if (token != null && param != null) {
                    return $('form input[name="' + param + '"]').forEach(
                      function (input) {
              ...
              (function () {
                ...
                Rails.handleRemote = function (e) {
                  ...
                  withCredentials = element.getAttribute(
                  ...
                  if (matches(element, Rails.formSubmitSelector)) {
                    ...
                    method =
                      getData(element, "ujs:submit-button-formmethod") ||
                      element.method;
                    url =
                ...
                Rails.preventInsignificantClick = function (e) {
                  ...
                  link = this;
                  method = (
                    link.getAttribute("data-method") || "GET"
                  ).toUpperCase();
                  data = link.getAttribute("data-params");
                  metaClick = e.metaKey || e.ctrlKey;
                  insignificantMetaClick =
                    metaClick && method === "GET" && !data;
              ...
              (function () {
                ...
                if (
                  window.Rails === Rails &&
                  fire(document, "rails:attachBindings")
                ) {
                  Rails.start();
                }
              }.call(this));
              ...
              (function () {
                  ...
                  e.History = (function () {
                    ...
                    return (
                      ...
                      (r.prototype.push = function (t, r) {
                        return (
                          (t = e.Location.wrap(t)), this.update("push", t, r)
                        );
                      }),
                      (r.prototype.replace = function (t, r) {
                        return (
                          (t = e.Location.wrap(t)), this.update("replace", t, r)
                        );
                      }),
                      ...
                      (t.prototype.getPermanentElementsPresentInSnapshot =
                        function (t) {
                          ...
                          for (
                            ...
                            (e = o[r]),
                              t.getPermanentElementById(e.id) && i.push(e);
                          }
                    ...
                    return (
                          ...
                          ? ((t = this.shouldIssueRequest()),
                            this.render(function () {
                              ...
                              return (
                                ...
                                "function" ==
                                  typeof (r = this.adapter).visitRendered &&
                      ...
                      (r.prototype.requestCompletedWithResponse = function (
                        ...
                        return (
                          (this.response = t),
                          null != r &&
                            (this.redirectedToLocation = e.Location.wrap(r)),
                    ...
                    return (
                      ...
                      (r.prototype.applicationAllowsVisitingLocation =
                        function (t) {
                          ...
                          return (
                            (e =
                              this.notifyApplicationBeforeVisitingLocation(t)),
                            !e.defaultPrevented
                          );
                        }),
                ...
                function () {
                  ...
                  (e.start = function () {
                    ...
                    (r = function r() {
                      return (
                        null == window.Turbolinks && (window.Turbolinks = e),
                        n()
                      );
                    }),
                    (t = function t() {
